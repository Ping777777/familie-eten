...
const S = {
  nl: {
    ...
    recipesNotLoaded: "Recepten nog niet geladen — probeer het zo weer",
  ...
  en: {
    ...
    recipesNotLoaded: "Recipes haven't loaded yet — try again in a moment",
  ...
  ru: {
    ...
    recipesNotLoaded: "Рецепты ещё не загружены — попробуйте через момент",
