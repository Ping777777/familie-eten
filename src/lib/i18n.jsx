...
const S = {
  nl: {
    ...
    used: "al gepland", remove: "Verwijder", cancel: "Annuleer", done: "Klaar",
  ...
  en: {
    ...
    used: "already planned", remove: "Remove", cancel: "Cancel", done: "Done",
  ...
  ru: {
    ...
    used: "уже в плане", remove: "Удалить", cancel: "Отмена", done: "Готово",
